const ApeContractData = {
  ...
  abi: [
    ...
    {
      inputs: [
        { internalType: "uint16", name: "_mintAmount", type: "uint16" },
    ...
    {
      inputs: [{ internalType: "uint8", name: "_limit", type: "uint8" }],
...
export default ApeContractData;
